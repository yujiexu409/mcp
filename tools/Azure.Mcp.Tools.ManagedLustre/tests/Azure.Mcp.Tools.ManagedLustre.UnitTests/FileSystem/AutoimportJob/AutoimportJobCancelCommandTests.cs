...
public class AutoimportJobCancelCommandTests
{
    private readonly IServiceProvider _serviceProvider;
    private readonly IManagedLustreService _managedLustreService;
    private readonly ILogger<AutoimportJobCancelCommand> _logger;
    private readonly AutoimportJobCancelCommand _command;
    ...
    public AutoimportJobCancelCommandTests()
    {
        _managedLustreService = Substitute.For<IManagedLustreService>();
        _logger = Substitute.For<ILogger<AutoimportJobCancelCommand>>();
    ...
    {
        // Arrange
        _managedLustreService.CancelAutoimportJobAsync(
        ...
        await _managedLustreService.Received(1).CancelAutoimportJobAsync(
            Arg.Is(_subscription),
            Arg.Is(_resourceGroup),
            Arg.Is(_fileSystemName),
            Arg.Is(_jobName),

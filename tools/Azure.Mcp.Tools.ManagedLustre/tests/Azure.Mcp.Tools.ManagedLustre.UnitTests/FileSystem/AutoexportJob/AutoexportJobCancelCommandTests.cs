...
public class AutoexportJobCancelCommandTests
{
    private readonly IServiceProvider _serviceProvider;
    private readonly IManagedLustreService _managedLustreService;
    private readonly ILogger<AutoexportJobCancelCommand> _logger;
    private readonly AutoexportJobCancelCommand _command;
    ...
    public AutoexportJobCancelCommandTests()
    {
        _managedLustreService = Substitute.For<IManagedLustreService>();
        _logger = Substitute.For<ILogger<AutoexportJobCancelCommand>>();
